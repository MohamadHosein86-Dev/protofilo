...
const data = [
  { id: 1, name: "Zarinpal", new: true, describ: "(-✅ deployed ✅-) A Next.js web app featuring landing pages (Home, Products, Pricing, About, Contact) and user/admin dashboards with dark/light theme, animations, and charts.Packages: Next 15, React 19, Tailwind CSS 4, Radix UI, lucide-react, framer-motion/motion, Recharts, clsx, class-variance-authority, next-themes, , moment-jalaali, react-icons.", date: "March 2025", img: "/zarinpal1.png", demo: "https://zarinpalnext.netlify.app", github: "https://github.com/MohamadHosein86-Dev/Zarinpal" },
  { id: 2, name: "solgen", new: true, describ: "(-✅ deployment ✅-) (-❌ privet code ❌-) An AI-powered Next.js (15.5.2) app with Tailwind CSS (v4), Redux Toolkit, and TypeScript for generating memes/images from text prompts or uploads.Includes prompt and meme pages, chat history, and API routes (generate/upload), with ESLint and PostCSS in the toolchain.", date: "september 2025", img: "/ai-meme100.png", demo: "https://solgen-dev.vercel.app" },
  { id: 3, name: "DashStack", new: false, describ: "(-✅ deployed ✅-) A professional dashboard application with multiple templates and various options for exporting.", date: "March 2025", img: "project/Dashstack.png", demo: "https://dash-stack-murex.vercel.app", github: "https://github.com/MohamadHosein86-Dev/DashStack" },
  ...
  { id: 5, name: "Cryptoverse", new: false, describ: "(-✅ deployed ✅-) A program for real-time display of cryptocurrencies with interactive charts, including fluctuation charts for each digital currency, with the ability to select and view detailed information.", date: "March 2025", img: "project/Cryptoverse.png", demo: "https://cryptoverse-next.netlify.app/", github: "https://github.com/MohamadHosein86-Dev/Cryptoverse" },
  { id: 6, name: "Tarkhineh restaurant", new: false, describ: "(-✅ deployed ✅-) Modern management dashboard with advanced analytics and data visualization components ", date: "March 2024", img: "/image10.png", demo: "https://tarkhineh-f6ib.vercel.app", github: "https://github.com/MohamadHosein86-Dev/Tarkhineh" }
];
