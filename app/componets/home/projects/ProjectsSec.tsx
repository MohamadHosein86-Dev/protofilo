...
const data = [
  { id: "6", name: "Ai meme", new: true, describ: "(-❌ not deployed ❌-) of a landing page, user dashboard, admin panel, and payment gateway in the Nova AR project using React, Tailwind, Framer Motion, and Shadcn UI. The goal was to provide smooth animations and an optimized user experience. Additionally, an advanced feature for uploading and displaying 3D files in AR was implemented, taking user interaction with 3D content to a new level.", date: "March 2025", img: "/ai-meme100.png", demo: "", github: "" },
  ...
  { id: "4", name: "Zarinpal", new: true, describ: "(-✅ deployed ✅-) of a landing page, user dashboard, admin panel, and payment gateway in the Nova AR project using React, Tailwind, Framer Motion, and Shadcn UI. The goal was to provide smooth animations and an optimized user experience. Additionally, an advanced feature for uploading and displaying 3D files in AR was implemented, taking user interaction with 3D content to a new level.", date: "March 2025", img: "/zarinpal1.png", demo: "", github: "" },
  { id: "5", name: "Pilisok", new: true, describ: "(-✅ deployed ✅-) of a landing page, user dashboard, admin panel, and payment gateway in the Nova AR project using React, Tailwind, Framer Motion, and Shadcn UI. The goal was to provide smooth animations and an optimized user experience. Additionally, an advanced feature for uploading and displaying 3D files in AR was implemented, taking user interaction with 3D content to a new level.", date: "March 2025", img: "/petshop.png", demo: "", github: "" }
];
