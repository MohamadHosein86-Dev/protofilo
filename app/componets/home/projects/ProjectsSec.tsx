...
const data = [
  ...
  { id: 5, name: "Tarkhineh restaurant", new: false, describ: "(-✅ deployed ✅-) Modern management dashboard with advanced analytics and data visualization components ", date: "March 2024", img: "/image10.png", demo: "https://tarkhineh-f6ib.vercel.app", github: "https://github.com/MohamadHosein86-Dev/Tarkhineh" },
  { id: 6, name: "Cryptoverse", new: false, describ: "(-✅ deployed ✅-) A program for real-time display of cryptocurrencies with interactive charts, including fluctuation charts for each digital currency, with the ability to select and view detailed information.", date: "March 2025", img: "project/Cryptoverse.png", demo: "https://cryptoverse-next.netlify.app/", github: "https://github.com/MohamadHosein86-Dev/Cryptoverse" }
];
